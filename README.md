...
**[hft-lob](https://github.com/Ronak-Mahajan/hft-lob)**: lock-free C++20 order book for NASDAQ ITCH 5.0. 10M+ messages/second on one core, 110M+ across 23 cores via wait-free sharding, verified byte-for-byte against a sequential reference.
